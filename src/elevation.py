...
data_menor = data_menor.head(2090)
def calculate_distance_openservice(row):  
    if row.name not in dict_routes.keys(): 
        try:
            ...
            print(coords)
            client = openrouteservice.Client(key='5b3ce3597851110001cf62489f927c7f6b894651abafcf246735aadb') # Specify your personal API key
